...
#define GPIO_SPI1_SS1   BIT1
#define GPIO_SPI1_SS2   BIT2
#define GPIO_SPI1_SS3   BIT3
...
static inline void wmt_spi_clock_enable(void)
{
	...
	if (g_use_ss0) {
		...
		PULL_EN_GP18_UART_BYTE_VAL |= GPIO_SD0_DATA0;
		PULL_CTRL_GP18_UART_BYTE_VAL |= GPIO_SD0_DATA0;
	}
	if (g_use_ss1) {
		//GPIO_CTRL_GP0_BYTE_VAL &= ~GPIO_SPI1_SS1;
		PULL_EN_GP22_JTAG_BYTE_VAL |= GPIO_SPI1_SS1;
		PULL_CTRL_GP22_JTAG_BYTE_VAL |= GPIO_SPI1_SS1;
	}
	if (g_use_ss2) {
		//GPIO_CTRL_GP1_BYTE_VAL &= ~GPIO_SPI1_SS2;
		PULL_EN_GP22_JTAG_BYTE_VAL |= GPIO_SPI1_SS2;
		PULL_CTRL_GP22_JTAG_BYTE_VAL |= GPIO_SPI1_SS2;
	}
	if (g_use_ss3) {
		//GPIO_CTRL_GP1_BYTE_VAL &= ~GPIO_SPI1_SS3;
		PULL_EN_GP22_JTAG_BYTE_VAL |= GPIO_SPI1_SS3;
		PULL_CTRL_GP22_JTAG_BYTE_VAL |= GPIO_SPI1_SS3;
	}
